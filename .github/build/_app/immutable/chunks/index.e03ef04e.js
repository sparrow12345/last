...
function U(t) {
	...
	for (let l = 0; l < e.length; l++) {
		const u = e[l].claim_order,
			f = (c > 0 && e[n[c]].claim_order <= u ? c + 1 : Q(1, c, (d) => e[n[d]].claim_order, u)) - 1;
		r[l] = n[f] + 1;
		const a = f + 1;
...
function bt(t, e, n) {
	k && !n ? V(t, e) : (e.parentNode !== t || e.nextSibling != n) && t.insertBefore(e, n || null);
}
function X(t) {
...
function Bt(t, e, n, r, c, s, i, o = [-1]) {
	...
	if (
		...
		e.intro && L(t.$$.fragment), st(t, e.target, e.anchor, e.customElement), W(), j();
	}
	_(l);
}
class Ht {
