import { H as d, s as k } from './index.e03ef04e.js';
import { a as m } from './paths.34cee5be.js';
const c = [];
function p(e, t = d) {
	let n;
	const o = new Set();
...
function v() {
	...
	async function o() {
		...
		if (r.ok) {
			const l = (await r.json()).version !== E;
...
const V = { url: h({}), page: h({}), navigating: p(null), updated: v() };
export {
	y as I,
	b as P,
	I as S,
